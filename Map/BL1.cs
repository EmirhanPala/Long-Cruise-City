        ...
        private void MCI_BlackwoodGP(int PLID)
        {
            try
            {
                ...
                */
                ...
                if (Conn.IsBeingTowed == false && Conn.InTowProgress == false && Conn.IsSuspect == false && Conn.InChaseProgress == false)
                {
                    ...
                    if (pathx >= -23 && pathx <= -21 && pathy >= -39 && pathy <= -35)
                    {
                        if (Conn.ExitZone == 0)
                        {
                            if (direction < 100)
                            {
                                MsgAll("^6>>^7 " + Conn.NoColPlyName + " was fined ^1$500 ^7for wrong entry");
                                Conn.Cash -= 500;
                                Conn.ExitZone = 2;
                            }
                        }
                ...
                if (pathx > -248 && pathx < 390 && pathy > -8 && pathy < 733 && kmh < 839 && Conn.IsBeingTowed == true)
                {
                    foreach (clsConnection Con in Connections)
                    {
                        if (Con.Towee == Conn.UniqueID)
                        {
                            ...
                            MsgAll("^6>>^7 " + Con.NoColPlyName + " was rewarded ^2$300");
                ...
                #region ' Top End Corner & Hriso's House '
                if (node < 38)
                {
                    if (pathx >= 8 && pathx <= 14 && pathy >= 132 && pathy <= 136)
                    {
                        ...
                        Conn.LocationBox = "^3Hriso's House";
                        Conn.Location = "Hriso's House";
                        Conn.LastSeen = "Hriso's House, Blackwood";
                    }
                    else
                    {
                ...
                #region ' Hell's Highway & Martin's House '
                if (node > 60 && node < 134)
                {
                    if (pathx >= 60 && pathx <= 64 && pathy >= 74 && pathy <= 79)
                    {
                        ...
                        Conn.LocationBox = "^3Martin's House";
                        Conn.Location = "Martin's House";
                        Conn.LastSeen = "Martin's House, Blackwood";
                    }
                    else
                    {
                        #region ' Speedlimit 140kmh/87mph '
                ...
                #region ' The Hook's Corner & Lottery '
                if (node > 133 && node < 167)
                {
                    if (pathx >= 134 && pathx <= 138 && pathy >= -231 && pathy <= -228)
                    {
                        ...
                        Conn.LocationBox = "^3Lottery";
                        Conn.Location = "Lottery";
                        Conn.LastSeen = "Lottery, Blackwood";
                    }
                    else
                    {
                        #region ' Speedlimit 97kmh/60mph '
                ...
                #region ' Junction Road & Elly's House '
                if (node > 231 && node < 260)
                {
                    if (pathx >= -49 && pathx <= -47 && pathy >= -134 && pathy <= -129)
                    {
                        ...
                        Conn.LocationBox = "^3Elly's House";
                        Conn.Location = "Elly's House";
                        Conn.LastSeen = "Elly's House, Blackwood";
                    }
                    else
                    {
                        #region ' Speedlimit 80kmh/50mph '
                ...
                if (Conn.InBankDist <= 4 && (mph <= 4))
                {
                    ...
                    {
                        string EstablishmentName = "^7City ^2Bank";
                ...
                if (Conn.InStoreDist <= 4 && (mph <= 4))
                {
                    ...
                    {
                        string EstablishmentName = "^7Dany's Store";
                        ...
                        else if (Conn.IsSuspect == false && RobberUCID != Conn.UniqueID)
                        {
                            if (Conn.IsOfficer == false && Conn.IsCadet == false && Conn.IsTowTruck == false)
                            {
                                ...
                                if (Conn.InGameIntrfc == 0 && Conn.DisplaysOpen == false)
                                {
                                    ...
                                    {
                                        InSim.Send_BTN_CreateButton("^2Get a Job ^7for Lottery Escort!", Flags.ButtonStyles.ISB_LEFT, 4, 100, 73, 54, 116, Conn.UniqueID, 2, false);
            ...
            {
                MsgAll("^6>>^7 Map Error. Please reload the Application!");
