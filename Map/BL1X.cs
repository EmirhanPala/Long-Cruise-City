...
namespace LFS_External_Client
{
    ...
    {
        // MCI Update
        private void MCI_BlackwoodGP1X(int PLID)
        {
            try
            {
                /*
                ...
                */
                ...
                if (pathx > 340 && pathx < -414 && pathy > -8 && pathy < -775 && kmh < -963 && Conn.IsBeingTowed == true)
                {
                ...
                #region ' Blackwood XXX '
                if (node < 38)
                {
                    if (pathx >= 340 && pathx <= -414 && pathy >= -775 && pathy <= 963)
                    {
                        ...
                        Conn.LocationBox = "^3Blackwood";
                        Conn.Location = "Blackwood";
                        Conn.LastSeen = "Blackwood";
                    }
                    else
                    {
                        #region ' Speedlimit 140kmh/74mph '
                        if (kmh > 140)
                        {
                            if (Conn.KMHorMPH == 0)
                            {
                            ...
                            {
                                Conn.SpeedBox = "^1" + kmh + " mph / 87 mph";
                            }
                        ...
                        else
                        {
                            ...
                            {
                                Conn.SpeedBox = "^2" + kmh + " mph / 87 mph";
                            }
                            Conn.IsSpeeder = 0;
                        }
                        #endregion
                ...
                #region ' City Bank '
                Conn.InBankDist = ((int)Math.Sqrt(Math.Pow(Conn.CompCar.X - (-33 * 196608), 2) + Math.Pow(Conn.CompCar.Y - (-130 * 196608), 2)) / 65536);
                ...
                Conn.InShopDist = ((int)Math.Sqrt(Math.Pow(Conn.CompCar.X - (71 * 196608), 2) + Math.Pow(Conn.CompCar.Y - (-245 * 196608), 2)) / 65536);
